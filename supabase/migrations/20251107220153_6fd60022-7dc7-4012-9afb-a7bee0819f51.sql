...
-- Enum pour catégories d'espèces (vérifier si existe)
DO $$ BEGIN
...
-- Table: Espèces
CREATE TABLE IF NOT EXISTS public.especes (
...
CREATE INDEX IF NOT EXISTS idx_especes_categorie ON public.especes(categorie);
CREATE INDEX IF NOT EXISTS idx_especes_nom ON public.especes(nom);
...
CREATE INDEX IF NOT EXISTS idx_engins_nom ON public.engins(nom);

-- Table: Strates (zones de pêche mineures)
CREATE TABLE IF NOT EXISTS public.strates (
  id UUID PRIMARY KEY DEFAULT gen_random_uuid(),
  nom TEXT NOT NULL UNIQUE,
  code TEXT UNIQUE,
  description TEXT,
...
CREATE INDEX IF NOT EXISTS idx_strates_nom ON public.strates(nom);
...
CREATE INDEX IF NOT EXISTS idx_sites_nom ON public.sites(nom);
CREATE INDEX IF NOT EXISTS idx_sites_strate ON public.sites(strate_id);
...
CREATE INDEX IF NOT EXISTS idx_cooperatives_nom ON public.cooperatives(nom);
CREATE INDEX IF NOT EXISTS idx_cooperatives_site ON public.cooperatives(site_id);
...
CREATE INDEX IF NOT EXISTS idx_proprietaires_nom ON public.proprietaires(nom, prenom);
CREATE INDEX IF NOT EXISTS idx_proprietaires_piece ON public.proprietaires(piece_id);

-- Table: Pirogues
CREATE TABLE IF NOT EXISTS public.pirogues (
  id UUID PRIMARY KEY DEFAULT gen_random_uuid(),
  nom TEXT NOT NULL,
...
CREATE INDEX IF NOT EXISTS idx_pirogues_immatriculation ON public.pirogues(immatriculation);
CREATE INDEX IF NOT EXISTS idx_pirogues_proprietaire ON public.pirogues(proprietaire_id);
CREATE INDEX IF NOT EXISTS idx_pirogues_cooperative ON public.pirogues(cooperative_id);
CREATE INDEX IF NOT EXISTS idx_pirogues_site ON public.pirogues(site_attache_id);
CREATE INDEX IF NOT EXISTS idx_pirogues_statut ON public.pirogues(statut);

-- Table: Armements (pêche industrielle)
CREATE TABLE IF NOT EXISTS public.armements (
  id UUID PRIMARY KEY DEFAULT gen_random_uuid(),
  nom TEXT NOT NULL UNIQUE,
  adresse TEXT,
  telephone TEXT,
...
CREATE INDEX IF NOT EXISTS idx_armements_nom ON public.armements(nom);

-- Table: Navires (pêche industrielle)
CREATE TABLE IF NOT EXISTS public.navires (
  id UUID PRIMARY KEY DEFAULT gen_random_uuid(),
  nom TEXT NOT NULL,
...
CREATE INDEX IF NOT EXISTS idx_navires_matricule ON public.navires(matricule);
CREATE INDEX IF NOT EXISTS idx_navires_armement ON public.navires(armement_id);
CREATE INDEX IF NOT EXISTS idx_navires_statut ON public.navires(statut);
...
DROP POLICY IF EXISTS "Tous peuvent consulter les espèces" ON public.especes;
CREATE POLICY "Tous peuvent consulter les espèces"
  ON public.especes FOR SELECT
  TO authenticated
  USING (true);

DROP POLICY IF EXISTS "Agents et admins peuvent gérer les espèces" ON public.especes;
...
DROP POLICY IF EXISTS "Tous peuvent consulter les engins" ON public.engins;
CREATE POLICY "Tous peuvent consulter les engins"
  ON public.engins FOR SELECT
  TO authenticated
  USING (true);

DROP POLICY IF EXISTS "Agents et admins peuvent gérer les engins" ON public.engins;
...
DROP POLICY IF EXISTS "Tous peuvent consulter les strates" ON public.strates;
CREATE POLICY "Tous peuvent consulter les strates"
  ON public.strates FOR SELECT
  TO authenticated
  USING (true);

DROP POLICY IF EXISTS "Admins et directions peuvent gérer les strates" ON public.strates;
...
DROP POLICY IF EXISTS "Tous peuvent consulter les sites" ON public.sites;
CREATE POLICY "Tous peuvent consulter les sites"
  ON public.sites FOR SELECT
  TO authenticated
  USING (true);

DROP POLICY IF EXISTS "Admins et directions peuvent gérer les sites" ON public.sites;
...
DROP POLICY IF EXISTS "Tous peuvent consulter les coopératives" ON public.cooperatives;
CREATE POLICY "Tous peuvent consulter les coopératives"
  ON public.cooperatives FOR SELECT
  TO authenticated
  USING (true);

DROP POLICY IF EXISTS "Gestionnaires peuvent modifier leur coopérative" ON public.cooperatives;
...
DROP POLICY IF EXISTS "Admins et directions peuvent créer coopératives" ON public.cooperatives;
CREATE POLICY "Admins et directions peuvent créer coopératives"
...
DROP POLICY IF EXISTS "Lecture propriétaires pour rôles autorisés" ON public.proprietaires;
...
DROP POLICY IF EXISTS "Agents et admins peuvent gérer propriétaires" ON public.proprietaires;
...
DROP POLICY IF EXISTS "Lecture pirogues pour rôles autorisés" ON public.pirogues;
...
DROP POLICY IF EXISTS "Agents et gestionnaires peuvent gérer pirogues" ON public.pirogues;
