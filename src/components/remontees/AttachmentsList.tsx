...
import { Image, Video, FileText, Download, ExternalLink, Loader2, Paperclip } from "lucide-react";
            ...
            {attachments.map((attachment) => (
              ...
              >
                {attachment.mime_type.startsWith("image/") ? (
                  <img
                    src={`${supabase.storage.from("remontees-attachments").getPublicUrl(attachment.file_path).data.publicUrl}`}
