...
const rolesConfig = [
  ...
  },
  {
    role: "ministre",
    label: "Ministre",
    description: "Dashboards exécutifs et décisions stratégiques",
    permissions: {
  ...
  },
  {
    role: "dgpa",
    label: "DGPA",
    description: "Licences, application Code des pêches",
    permissions: {
  ...
  },
  {
    role: "anpa",
    label: "ANPA",
    description: "Exécution opérationnelle politique pêche",
    permissions: {
      users: { read: true, write: false, delete: false },
  ...
  },
  {
    role: "agasa",
    label: "AGASA",
    description: "Contrôle sanitaire produits halieutiques",
    permissions: {
      users: { read: false, write: false, delete: false },
      captures: { read: true, write: false, delete: false },
      licences: { read: true, write: false, delete: false },
  ...
  },
  {
    role: "oprag",
    label: "OPRAG",
    description: "Gestion portuaire et débarquements",
    permissions: {
      users: { read: false, write: false, delete: false },
      captures: { read: true, write: true, delete: false },
      licences: { read: true, write: false, delete: false },
  ...
  },
  {
    role: "dgddi",
    label: "DGDDI (Douanes)",
    description: "Contrôle import/export produits mer",
    permissions: {
      users: { read: false, write: false, delete: false },
      captures: { read: true, write: false, delete: false },
      licences: { read: true, write: false, delete: false },
