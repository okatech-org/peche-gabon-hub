...
const navItems: NavItem[] = [
  ...
  {
    title: "Inspections",
    url: "/inspecteur-dashboard/inspections",
    icon: ClipboardList,
  },
  {
    title: "Carte",
    url: "/inspecteur-dashboard/carte",
    icon: Map,
  },
  {
    title: "Infractions",
    url: "/inspecteur-dashboard/infractions",
    icon: AlertTriangle,
  },
  {
    title: "Licences",
...
export function InspecteurSidebar() {
      ...
      <SidebarHeader className="border-b border-border p-4">
        <div className="flex items-center gap-3">
          ...
          <div className="flex-1 min-w-0 group-data-[collapsible=icon]:hidden">
            ...
            <p className="text-xs text-muted-foreground truncate">Espace Inspecteur</p>
          </div>
        </div>
      </SidebarHeader>
